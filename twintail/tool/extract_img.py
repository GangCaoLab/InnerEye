...
from twintail.utils.io.lif import read_series_uri
from twintail.utils.io.h5 import write_array, read_array
...
def extract_samples(json_path:str, dst_dir:str):
    ...
    :dst_dir: Target directory to save extracted images.
    """
